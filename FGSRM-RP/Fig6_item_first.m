...
if run
    ...
    save('results\Netflix_item_first_Running_time_user_based.mat','Running_time')
    save('results\Netflix_item_first_MAE_user_based.mat','MAE')

else
    load('results\Netflix_item_first_Running_time_user_based.mat')
...
saveas(gcf,'results\Netflix_item_first_Com_ratio_MAE_user_based.fig')
saveas(gcf,'results\Netflix_item_first_Com_ratio_MAE_user_based.jpg')
saveas(gcf,'results\Netflix_item_first_Com_ratio_MAE_user_based.png')
...
tick={'1%','1.5%','2%','2.5%','3%','3.5%','4%','4.5%','5%'};
set(gca,'XTickLabel',tick)
saveas(gcf,'results\Netflix_item_first_Com_ratio_Running_time_user_based.fig')
saveas(gcf,'results\Netflix_item_first_Com_ratio_Running_time_user_based.jpg')
saveas(gcf,'results\Netflix_item_first_Com_ratio_Running_time_user_based.png')
...
if run
    ...
    save('results\Netflix_item_first_MAE_item_based.mat','MAE')
    save('results\Netflix_item_first_Running_time_item_based.mat','Running_time')

else

    load('results\Netflix_item_first_MAE_item_based.mat')
    load('results\Netflix_item_first_Running_time_item_based.mat')
...
tick={'1%','1.5%','2%','2.5%','3%','3.5%','4%','4.5%','5%'};
set(gca,'XTickLabel',tick)
saveas(gcf,'results\Netflix_item_first_Com_ratio_MAE_item_based.fig')
saveas(gcf,'results\Netflix_item_first_Com_ratio_MAE_item_based.jpg')
saveas(gcf,'results\Netflix_item_first_Com_ratio_MAE_item_based.png')
...
tick={'1%','1.5%','2%','2.5%','3%','3.5%','4%','4.5%','5%'};
set(gca,'XTickLabel',tick)
saveas(gcf,'results\Netflix_item_first_Com_ratio_Running_time_item_based.fig')
saveas(gcf,'results\Netflix_item_first_Com_ratio_Running_time_item_based.jpg')
saveas(gcf,'results\Netflix_item_first_Com_ratio_Running_time_item_based.png')
