%%  Table 5 Netflix all five item-first
close all
clear all


load('data\Ratings_all_five_itemfirst.mat')
...
if run
    ...
    M=Ratings_five_itemfirst.data;  %% The row is item and the column is user
    M=M';
    ...
    save('results\Tab5_itemfirst_MAE_userbased.mat','MAE')
    save('results\Tab5_itemfirst_Running_time_userbased.mat','Running_time')
else
    load('results\Tab5_itemfirst_MAE_userbased.mat')
    load('results\Tab5_itemfirst_Running_time_userbased.mat')
end
itemfirst_userbased.Running_time=Running_time;
...
set(l,'Fontsize',16);
saveas(gcf,'results\Tab5_itemfirst_userbased.fig')
saveas(gcf,'results\Tab5_itemfirst_userbased.jpg')
saveas(gcf,'results\Tab5_itemfirst_userbased.png')
...
if run
    ...
    save('results\Tab5_itemfirst_MAE_itembased.mat','MAE')
    save('results\Tab5_itemfirst_Running_time_itembased.mat','Running_time')
else
    load('results\Tab5_itemfirst_MAE_itembased.mat')
    load('results\Tab5_itemfirst_Running_time_itembased.mat')
end
itemfirst_itembased.Running_time=Running_time;
...
saveas(gcf,'results\Tab5_itemfirst_itembased.fig')
saveas(gcf,'results\Tab5_itemfirst_itembased.jpg')
saveas(gcf,'results\Tab5_itemfirst_itembased.png')



disp('*Speedup factor for user-based prediction in Netflix item first data:');
Running_time=itemfirst_userbased.Running_time;
itemfirst_userbased_SF=Running_time(1:5)/Running_time(6)

disp('*Speedup factor for item-based prediction in Netflix item first data:');
Running_time=itemfirst_itembased.Running_time;
itemfirst_itembased_SF=Running_time(1:5)/Running_time(6)
